...
public interface Watcher {
    ...
    interface Event {
        ...
        @InterfaceAudience.Public
        enum KeeperState {
            /** Unused, this state is never generated by the server 不使用，服务器不会生成 */
            @Deprecated
            Unknown(-1),

            /** The client is in the disconnected state - it is not connected
             * to any server in the ensemble. 客户端是断开状态 */
            Disconnected(0),
             ...
             * creation). 客户端是连接状态-连接了服务器集群中的一个服务器 */
            SyncConnected(3),
             ...
             * 客户端被关闭了。服务器不会生成该状态，当本地调用{@link ZooKeeper#close()}
             * 或{@link ZooKeeper#close(int)} 时会生成
             */
            Closed(7);
